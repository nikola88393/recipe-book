...
The signature move is the custom Anthropic Serif typeface — a medium-weight serif with generous proportions that gives every headline the gravitas of a book title. Combined with organic, hand-drawn-feeling illustrations in celadon (#94C595), black, and muted green, the visual language says "thoughtful companion" rather than "powerful tool." The serif headlines breathe at tight-but-comfortable line-heights (1.10–1.30), creating a cadence that feels more like reading an essay than scanning a product page.
...
* Celadon brand accent (#94C595) — warm, earthy, deliberately un-tech
...
* **Celadon Brand (#94C595):** The core brand color — a soft, earthy green used for primary CTA buttons, brand moments, and the signature accent. Deliberately organic and un-tech.
* **Celadon Accent (#A1E8AF):** A lighter, brighter variant of the brand color used for text accents, links on dark surfaces, and secondary emphasis.
...
Claude's design is gradient-free in the traditional sense. Depth and visual richness come from the interplay of warm surface tones, organic illustrations, and light/dark section alternation. The warm palette itself creates a "gradient" effect as the eye moves through cream $\rightarrow$ sand $\rightarrow$ stone $\rightarrow$ charcoal $\rightarrow$ black sections.
...
* **Brand Celadon**
* Background: Celadon Brand (#94C595)
* Text: Ivory (#faf9f5)
* Radius: 8–12px
* Shadow: ring-based (#94C595 0px 0px 0px 0px, #94C595 0px 0px 0px 1px)
...
* CTA: Celadon Brand button or White Surface button
...
* Hand-drawn-feeling vector illustrations in celadon, black, and muted green
...
* Use Celadon Brand (#94C595) only for primary CTAs and the highest-signal brand moments
...
* Don't introduce saturated colors beyond Celadon — the palette is deliberately muted
...
* **Feature sections:** Multi-column $\rightarrow$ stacked single column
* **Hero text:** 64px $\rightarrow$ 36px $\rightarrow$ ~25px progressive scaling
* **Model cards:** 3-column $\rightarrow$ stacked vertical
...
* Brand CTA: "Celadon Brand (#94C595)"
...
* "Create a hero section on Parchment (#f5f4ed) with a headline at 64px Anthropic Serif weight 500, line-height 1.10. Use Anthropic Near Black (#141413) text. Add a subtitle in Olive Gray (#5e5d59) at 20px Anthropic Sans with 1.60 line-height. Place a Celadon Brand (#94C595) CTA button with Ivory text, 12px radius."
...
* Keep illustrations organic and conceptual — describe "hand-drawn-feeling" style